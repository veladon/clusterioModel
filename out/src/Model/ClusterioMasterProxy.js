...
class ClusterioMasterProxy {
    ...
    async SyncMapSettingsFileWithNodeInstance(node) {
        ...
        mapSettings.width = node.Width * Config_1.GridToFactorioCoordinateSystemMultiplier;
        mapSettings.height = node.Height * Config_1.GridToFactorioCoordinateSystemMultiplier;
